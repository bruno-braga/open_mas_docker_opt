...
to print_alive_agents
  let file_path "important/m1_alive.txt"
  file-open file_path
  let alive_agents ""
  ...
  [
    ...
    ;let model "m1"
    let teste py:runresult (word "send_agent_to_alive('" (alive_agents) "', 'm1')")
    print("NL: Envio de agente realizado com sucesso?")
    print (teste)
  ]
  file-close
...
to print_alive_agents_single
  ...
  [
    ...
    [
      ...
      ;let model "m1"
      let teste py:runresult (word "send_agent_to_alive('" (agent_id) "', 'm1')")
      print("NL: Envio de agente realizado com sucesso?")
      print (teste)
    ]
  ]
