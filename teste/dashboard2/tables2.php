        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Open MAS Simulation</h1>
                    <p class="mb-4">Here you can check data that each agent had when passed by the router. Click in "File" button to check Jason/JaCaMo information.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Simulation data</h6>
                        </div>
                        <div class="card-body">
